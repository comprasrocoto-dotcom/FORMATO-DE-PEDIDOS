...
export default function App() {
  ...
  return (
    ...
    <div>
    <div className="text-white font-bold text-sm">InsumoMaster</div>div>
    <div className="text-cyan-300 text-[10px] uppercase tracking-wider">Restaurantes Rocoto</div>div>
    </div>div>
    </div>div>
