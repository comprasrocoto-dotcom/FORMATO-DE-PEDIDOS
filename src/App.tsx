...
import { Database, Plus, FileSpreadsheet, Download, RefreshCw, BarChart3, List, LayoutGrid, ShoppingBag, FileText } from 'lucide-react';
                                ...
                                <div className="flex items-center justify-between h-16">
                                            <div className="flex items-center gap-3">
                                                          ...
                                                          <div className="flex flex-col">
                                                                          ...
                                                                          <span className="text-[10px] text-slate-400 font-medium uppercase tracking-[0.2em]">Compras Rocoto</span>span>
                                                          </div>div>
                                            </div>div>
                      ...
                      <div className="border-t border-slate-800">
                                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex gap-1">
                                            ...
                                            <button
                                                          ...
                                                          Pedido desde Drive
                                                          <span className="bg-brand-600 text-white text-[9px] px-1.5 py-0.5 rounded-full font-bold">NUEVO</span>span>
                                            </button>button>
                                </div>div>
                      </div>div>
              </header>header>
                                              ...
                                              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm mb-8">
                                                              ...
                                                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                                                <div className="space-y-1.5">
                                                                                                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Sede</label>label>
                                                                                                    <div className="relative">
                                                                                                                          <select
                                                                                                                            ...
                                                                                                                            {sedes.map(s => (
                                                                                                                                                                              <option key={s.id} value={s.nombre}>{s.nombre}</option>option>
                                                                                                                                                                            ))}
                                                              ...
                                                              <div className="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between">
                                                                                <div className="flex flex-col">
                                                                                                    <span className="text-[10px] font-bold text-slate-400 uppercase">Orden Global</span>span>
                                                                                                    <button
                                                                                                                            onClick={async () => {
                                                                                ...
                                                                                <p className="text-[10px] text-slate-400 italic">Los datos se guardan en tiempo real.</p>p>
                                                              </div>div>
                                              </div>div>
                                              ...
                                              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                                              <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
                                                                                <div>
                                                                                                    ...
                                                                                                    <h4 className="text-3xl font-bold text-slate-900 font-mono tracking-tighter">{proveedores.length}</h4>h4>
                                                                                </div>div>
                                                              ...
                                                              <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
                                                                                <div>
                                                                                                    ...
                                                                                                    <h4 className="text-3xl font-bold text-slate-900 font-mono tracking-tighter">{filteredInsumos.length}</h4>h4>
                                                                                </div>div>
                                                                                              ...
                                                                                              <div className="flex items-center gap-3">
                                                                                                                      <button
                                                                                                                                                  onClick={async () => {
                                                                                                                                                                                ...
                                                                                                                                                                                const proveedorName = selectedProveedorId ? proveedores.find(p => p.id === selectedProveedorId)?.nombre : "Todos los Proveedores";
                                                                                                                                                                                const total = active.reduce((acc, i) => acc + (i.precio * (quantities[i.id] || 0)), 0);
                                                                                                                                                                                const html = `<!DOCTYPE html><html><head><style>body{font-family:Arial,sans-serif;padding:40px;font-size:12px;} h1{color:#002060;text-align:center;} table{width:100%;border-collapse:collapse;margin:20px 0;} th{background:#002060;color:white;padding:10px;} td{padding:8px;border-bottom:1px solid #eee;} .total{font-weight:bold;font-size:16px;text-align:right;margin-top:20px;}</style></head><body><h1>ORDEN DE COMPRA OC-${nextNumber}</h1><p><b>Fecha:</b> ${new Date().toLocaleDateString()} | <b>Sede:</b> ${sede} | <b>Proveedor:</b> ${proveedorName}</p><table><thead><tr><th>Producto</th><th>Cantidad</th><th>Precio</th><th>Total</th></tr></thead><tbody>${active.map(i => `<tr><td>${i.nombre}</td><td>${quantities[i.id]}</td><td>$${i.precio.toLocaleString()}</td><td>$${((quantities[i.id]||0)*i.precio).toLocaleString()}</td></tr>`).join('')}</tbody></table><p class="total">TOTAL: $${total.toLocaleString()}</p><p><i>Elaboro: ${responsable}</i></p></body></html>`;
